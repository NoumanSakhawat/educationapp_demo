...
export default class CLPTextInput extends Component<AllInterface, any> {
    ...
    render() {
        let { containerStyle, mode, errorVisible, rightIconColor, rightIconName, rightIconSize, rightIconStyle, rightIconType, rightIconVisible, bottomText, errorText, errorIconVisible } = this.props;
